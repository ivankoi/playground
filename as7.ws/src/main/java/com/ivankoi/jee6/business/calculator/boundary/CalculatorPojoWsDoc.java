...
@WebService(targetNamespace="http://www.ivankoi.com/", serviceName="Calculator_pojo_ws_doc", wsdlLocation="WEB-INF/wsdl/CalculatorPojoWsDoc.wsdl")
@SOAPBinding(style=Style.DOCUMENT)
public class CalculatorPojoWsDoc {
