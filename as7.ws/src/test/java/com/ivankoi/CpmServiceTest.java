...
import eu.europa.ec.research.fp.services.project_list.v3.ResearchProjectsListService;
...
public class CpmServiceTest {
	...
	public void cpmSecuredInvoker() throws Exception {
		...
		ResearchProjectsListService service = new ResearchProjectsListService(wsdlURL, qname);
		HeaderHandlerResolver handlerResolver = new HeaderHandlerResolver("promis_user", "iMCcR0FH");
		service.setHandlerResolver(handlerResolver);
		
		IResearchProjectsListService port = service.getIResearchProjectsListServiceSoaphttp();
